...
if __name__=="__main__":
    #if len(sys.argv) != 4:
    #    print("Usage: py, test path, model path, output_path")
    #    exit(1)
    ...
    test_data_path = 's3://musically-bigdata/recommend_script/data/similar_click_model_offline/similar_click_model_offline_train_sample_daily/dt=20171121/'
